...
while True:
    ...
    #Handling all other cases except for degree 2
    elif power < 1 or int(power) != power:
    ...
    #Handling polynomial of degree 2
        ...
        if "x^2" not in quadratic:
            print("You didn't put a quadratic with degree 2")
        #To check if the quadratic is formatted correctly
        elif "=0" not in quadratic:
            print("You didn't include an '=0'")

        else:
            #Pointer variable to keep track of index of the parced quadratic 
            index = 0
            ...
            #To check if x^2 had a coefficient of 1
            if a == "":
                a = 1
            elif a == "+":
                a = 1
            ...
            #To check if x had the coefficient of 1 or -1
            if b == "":
                b = 1
            elif b == "+":
                b = 1
            ...
            #Turn the numbers from strings to floats 
            a = float(a)
            b = float(b)
            c = float(c)
